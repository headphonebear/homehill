...
│   ├── philosophy.md
│   ├── architecture.md
│   ├── uid-schema.md            # Moved from root
│   └── migration-2025.md        # This file!
...
| `/homehill_uid_schema.md` | `/docs/uid-schema.md` |
...
### Phase 2: Documentation Cleanup (2026-01-18) ✓
- Move UID schema to `docs/`
...
**Created:** 2025-12-28  
**Updated:** 2026-01-18 (renamed from restructure-2025.md)  
